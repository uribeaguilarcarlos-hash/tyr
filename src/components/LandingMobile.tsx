      ...
      <footer className={styles.footer}>
          <div className={styles.footerInner}>
            ...
            <div className={styles.footerNav}>
              ...
              <a href="https://linkedin.com/company/tyrcargo" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', justifyContent: 'center' }}>
